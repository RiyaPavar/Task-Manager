...
export const mockUsers: User[] = [
  { id: 'u1', name: 'Team Alpha', email: 'alpha@teamsync.com', avatarUrl: 'https://picsum.photos/seed/teamalpha/100/100' },
  { id: 'u2', name: 'Team Bravo', email: 'bravo@teamsync.com', avatarUrl: 'https://picsum.photos/seed/teambravo/100/100' },
  { id: 'u3', name: 'Team Charlie', email: 'charlie@teamsync.com', avatarUrl: 'https://picsum.photos/seed/teamcharlie/100/100' },
];
